...
statusTable.spellToStatus = T{
    ...
    [359] = 6, --silencega
    [253] = 2,  --sleep
    [259] = 2,  --sleep_II   (server applies SLEEP_I effect for both; ID 19 is unused by spells)
    [273] = 2,  --sleepga
    [274] = 2,  --sleepga_II
    [258] = 11, --bind
    [362] = 11, --bindga
    ...
    [237] = 130, --choke
    [236] = 129, --frost
    [608] = 4, --frost_breath (applies Paralysis, not Frost — blue/frost_breath.lua)
    [235] = 128, --burn
    [240] = 133, --drown
...
statusTable.GetStatusIdBySpellId = function(spellId)
    -- check our status effects for this spell
    return statusTable.spellToStatus[spellId];
end

statusTable.IsBuff = function(buffId)
    return statusTable.statusEffects[buffId] == 0;
end

statusTable.IsJugPet = function(petName)
    return statusTable.jugPets[petName] ~= nil;
end

statusTable.IsSpellcaster = function(jobAbv)
    return statusTable.spellcasters[jobAbv] ~= nil;
end

statusTable.GetSpAbilityName = function(jobAbv)
    return statusTable.spAbilitys[jobAbv];
end
