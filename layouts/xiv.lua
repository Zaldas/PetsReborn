-- layouts/xiv.lua
-- XIV-style layout for PetsReborn.
    ...
    targetFrame = {
        ...
        hp = {
            ...
            bar = {
                ...
                zOrder    = 1,
                animSpeed = 0.2,
                imgBg  = { path = 'layouts/assets/xiv/BarBG.png', size = {159,8},  pos = {3,2},  color = '#FFFFFFFF', sliceBorder = {60, 60, 6, 6},   zOrder = 1 },
                imgBar = { path = 'layouts/assets/xiv/Bar.png',   size = {157,8},  pos = {4,2},  color = '#FFFFFFFF', zOrder = 2 },
                imgFg  = { path = 'layouts/assets/xiv/BarFG.png', size = {165,14}, pos = {0,0},  color = '#FFFFFFFF', sliceBorder = {60, 60, 13, 13}, zOrder = 3 },
                bind = {
    ...
    petFrame = {
        ...
        hp = {
            ...
            bar = {
                ...
                zOrder    = 1,
                animSpeed = 0.2,
                imgBg  = { path = 'layouts/assets/xiv/BarBG.png', size = {104,8},  pos = {3,2},  color = '#F0FFFFFF', sliceBorder = {60, 60, 6, 6},   zOrder = 1 },
                imgBar = { path = 'layouts/assets/xiv/Bar.png',   size = {102,8},  pos = {4,2},  color = '#FFE3E8',   zOrder = 2 },
                imgFg  = { path = 'layouts/assets/xiv/BarFG.png', size = {110,14}, pos = {0,0},  color = '#F0FFFFFF', sliceBorder = {60, 60, 13, 13}, zOrder = 3 },
                bind = {
                    value      = 'pet.hppNorm',
                    color      = 'threshold',
                    visible    = 'pet.active',
        ...
        mp = {
            ...
            bar = {
                ...
                animSpeed = 0.2,
                imgBg  = { path = 'layouts/assets/xiv/BarBG.png', size = {104,8},  pos = {3,2},  color = '#F0FFFFFF', sliceBorder = {60, 60, 6, 6},   zOrder = 1 },
                imgBar = { path = 'layouts/assets/xiv/Bar.png',   size = {102,8},  pos = {4,2},  color = '#FFEE99',   zOrder = 2 },
                imgFg  = { path = 'layouts/assets/xiv/BarFG.png', size = {110,14}, pos = {0,0},  color = '#F0FFFFFF', sliceBorder = {60, 60, 13, 13}, zOrder = 3 },
                bind = {
                    value      = 'pet.mppNorm',
        ...
        tp = {
            ...
            bar = {
                ...
                animSpeed = 0.2,
                imgBg  = { path = 'layouts/assets/xiv/BarBG.png', size = {104,8},  pos = {3,2},  color = '#F0FFFFFF', sliceBorder = {60, 60, 6, 6},   zOrder = 1 },
                imgBar = { path = 'layouts/assets/xiv/Bar.png',   size = {102,8},  pos = {4,2},  color = '#DFF3FF',   zOrder = 2 },
                imgFg  = { path = 'layouts/assets/xiv/BarFG.png', size = {110,14}, pos = {0,0},  color = '#F0FFFFFF', sliceBorder = {60, 60, 13, 13}, zOrder = 3 },
                bind = {
                    value      = 'pet.tpNorm',
                    visible    = 'pet.active',
        ...
        recast = {
            ...
            charges = {
                pip = {
                    path       = 'layouts/assets/xiv/Pip.png',
                    size       = {20, 20},
                    pos        = {110, 0},
                    offset     = {14, 0},
                    color      = '#A0C8FFFF',
        ...
        -- never reach the element hue. The pip set lives under assets/ffxi/pips/ and is shared
        -- by both layouts -- it is untextured geometry, with no XIV-specific variant.
        maneuvers = {
            bind = {
                visible    = 'pet.active',
            ...
            -- petFrame.petTimer's line, so the font matches distance and petTimer.
